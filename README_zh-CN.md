...
> **立即体验** — 无需安装。打开 [Colab 演示笔记本](https://colab.research.google.com/github/Electricitysheep/pdf-pilot/blob/main/demo.ipynb) 在浏览器中直接转换 PDF。
...
| 特性 | **pdf_pilot** | pdfplumber | marker | pymupdf | unstructured |
|---|:---:|:---:|:---:|:---:|:---:|
| 自动引擎路由 | ✅ | ❌ | ❌ | ❌ | ❌ |
| 多引擎自动降级 | ✅ | ❌ | ❌ | ❌ | ❌ |
| 扫描件支持 | ✅ | ❌ | ✅ | ⚠️ | ✅ |
...
| 命令行 | ✅ | ❌ | ❌ | ❌ | ❌ |
| Python API | ✅ | ✅ | ✅ | ✅ | ✅ |
| 启动时间 | ⚡ 即时 | ⚡ 即时 | 🐢 ML模型 | ⚡ 即时 | 🐢 ML模型 |
| 许可证 | MIT | MIT | Apache 2.0 | MIT | MIT |

**pdf_pilot** 是唯一能根据你的文档类型自动适配的工具。其他工具都强制你选择。
